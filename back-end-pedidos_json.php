...
if(!isset($_GET["nuevoPedido"])) {
    ...
    if (!isset($_GET["pedido"])) {
        ...
        if ($pedidos === false) {
            ...
            echo "<tr><td colspan='6'><a href='back-end-pedidos_json.php?nuevoPedido=true'>Crear Nuevo Pedido</a></td></tr></table>";
        }
    } else {
    ...
    echo "<h1>Crear Nuevo Pedido</h1><form action = 'back-end-pedidos_json.php'  method = 'POST'>
                           ...
                           <div> <a href='back-end-pedidos_json.php'>Cancelar</a> <input type='submit' value='Crear'></div>              
                        </form>";
